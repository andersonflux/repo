...
from electrum_mona.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
                                  PartialTransaction, TxOutpoint, PartialTxInput,
                                  PartialTxOutput, Sighash)
from electrum_mona.util import bh2u, bfh
from electrum_mona.bitcoin import (deserialize_privkey, opcodes,
...
class TestTransaction(ElectrumTestCase):
    ...
    def test_tx_deserialize_for_signed_network_tx(self):
        ...
        self.assertEqual('MB6Sn1UbUkUNid38WAUbTdFBAgrhKyDds5', tx.outputs()[0].address)
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual('mona1qw508d6qejxtdg4y5r3zarvary0c5xw7kg5lnx5', addr_from_script('0014751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('mona1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7ks6uhtp', addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('mona1sw50q5sr2p9', addr_from_script('6002751e'))
        self.assertEqual('mona1zw508d6qejxtdg4y5r3zarvaryvz8pq8u', addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
        self.assertEqual('mona1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqtsd8k8', addr_from_script('512079be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798'))
        # almost but not quite
        self.assertEqual(None, addr_from_script('0013751e76e8199196d454941c45d1b3a323f1433b'))

        # base58 p2pkh
        self.assertEqual('MBamfEqEFDy5dsLWwu48BCizM1zpCoKw3U', addr_from_script('76a91428662c67561b95c79d2257d2a93d9d151c977e9188ac'))
        self.assertEqual('MJ8zuRbU35AoEUqzVgawR9SvhYNfaEcJ3Q', addr_from_script('76a914704f4b81cadb7bf7e68c08cd3657220f680f863c88ac'))
        # almost but not quite
        self.assertEqual(None, addr_from_script('76a9130000000000000000000000000000000000000088ac'))

        # base58 p2sh
        self.assertEqual('PCTzdjWauNipkYtToRZEHDMXb2adj9Evp8', addr_from_script('a9142a84cf00d47f699ee7bbc1dea5ec1bdecb4ac15487'))
        self.assertEqual('PWsuDix8G8pvVHTSF2vMKPFxnSiy4Ub5QS', addr_from_script('a914f47c8954e421031ad04ecd8e7752c9479206b9d387'))
        # almost but not quite
...
class TestTransactionTestnet(TestCaseForTestnet):
    ...
    def test_spending_op_cltv_p2sh(self):
        ...
        txout = PartialTxOutput.from_address_and_value(
            'tmona1q0p29rfu7ap3duzqj5t9e0jzgqzwdtd97pa5rhuz4r38t5a6dknyqxmyyaz', sats_less_fees)
        ...
        self.assertEqual('87debff8e523e5d4937c24a2c0265a517ffe004af2db2a36593a0437546494f0',
                         tx.txid())
    ...
    def test_spending_op_cltv_p2wsh(self):
        ...
        self.assertEqual("tmona1q9dn6qke9924xe3zmptmhrdge0s043pjxpjndypgnu2t9fvsd4crst0f9q0", from_addr)
        ...
        # Build the Transaction Output
        txout = PartialTxOutput.from_address_and_value(
            'tmona1qfj8lu0rafk2mpvk7jj62q8eerjpex3xlcadtupkrkhh5a73htmhs68e55m', sats_less_fees)
        ...
        self.assertEqual('60a49136975d4c21195c00bfda25de786293a9f2fb1a609f2a60718355f2c0fa',
                         tx.txid())
        self.assertEqual('',
                         tx.serialize())
