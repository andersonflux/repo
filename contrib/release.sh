...
# android
apk1="Electrum-mona-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-mona-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-mona-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-mona-$VERSION.0-arm64-v8a-release-unsigned.apk"
